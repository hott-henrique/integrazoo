    ...
    return Container(
      ...
      child: ListTile(
        ...
        subtitle: DropdownButton(
          ...
          isExpanded: true,
          items: Culture.values.map((c) => DropdownMenuItem(value: c, child: Text(c.toString()))).toList(),
          onChanged: (value) => setState(() => currentCulture = value!),
        ),
        dense: true,
        leading: const CircleAvatar(backgroundColor: Colors.white, foregroundColor: Colors.green, child: Icon(Icons.source)),
      )
    );
  }
