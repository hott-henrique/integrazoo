...
class YearlingWeightFormView extends StatefulWidget {
  final TextEditingController dateController;
  final TextEditingController weightController;
  final TextEditingController observationController;

  const YearlingWeightFormView({
    super.key,
  ...
  @override
  State<YearlingWeightFormView> createState() => _YearlingWeightFormViewState();
}

class _YearlingWeightFormViewState extends State<YearlingWeightFormView> {
