...
class TreatmentsDataLoader extends DataLoader {
  bool _isLoading = true;

  @override
  bool get isLoading => _isLoading;

  final List<Treatment> _data = [];
  ...
  Future<void> _loadData() async {
    ...
    _rowCount = isar.treatments.countSync();

    final treatments = isar.treatments.where().offset(_rowsPerPage * _page).limit(_rowsPerPage).findAllSync();

    _data.addAll(treatments);
  ...
  Treatment getElement(int index) {
