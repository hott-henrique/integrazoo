...
class FemaleSelectionDataLoader extends DataLoader {
  ...
  Future<void> _loadData() async {
    ...
    _rowCount  = isar.bovines.filter()
                             .sexEqualTo(Sex.female)
                             .isBreederEqualTo(true)
                             .finishIsNull()
                             .countSync();

    final bovines = isar.bovines.filter()
                                .sexEqualTo(Sex.female)
                                .isBreederEqualTo(true)
                                .finishIsNull()
                                .offset(_rowsPerPage * _page).limit(_rowsPerPage).findAllSync();
