...
class WeighingsDataLoader extends DataLoader {
  bool _isLoading = true;

  @override
  bool get isLoading => _isLoading;

  final List<Weighing> _data = [];
  ...
  Future<void> _loadData() async {
    ...
    _rowCount = isar.weighings.countSync();

    final weighings = isar.weighings.where().offset(_rowsPerPage * _page).limit(_rowsPerPage).findAllSync();

    _data.addAll(weighings);
